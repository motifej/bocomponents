...
export const buildTableHeader = (header, classes, request, order, orderBy, sortQuery, updateSort) => {
...
export const buildTableRow = (row, onRowClick, classes, decoder) => {
    ...
    export const createTableBody = (data, onRowClick, classes, decoder) => ( < TableBody > {
        data.map(row => {
